...
export default function DentalEvaluation() {
  ...
  const handleAddCondition = async (values: any) => {
    ...
    message.success('CondiciÃ³n agregada')
  }

  const handleDeleteCondition = (id: string) => {
    setConditions(conditions.filter((c) => c.id !== id))
    message.success('CondiciÃ³n eliminada')
  }
  ...
  const handleSaveEvaluation = async () => {
    ...
    try {
      ...
      message.success('EvaluaciÃ³n guardada exitosamente')
      handleReset()
    } catch (error) {
      message.error('Error al guardar evaluaciÃ³n')
    }
  }
