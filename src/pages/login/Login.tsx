...
import { UserOutlined, LockOutlined, LoginOutlined, RocketOutlined, CrownOutlined } from '@ant-design/icons'
          ...
          <div className="login-header">
            <div className="logo">
              {settings.logo ? (
                ...
                <CrownOutlined style={{ fontSize: '48px', color: settings.primaryColor }} />
              )}
            </div>
            <h1 style={{
              background: `linear-gradient(135deg, ${settings.primaryColor} 0%, ${settings.secondaryColor} 100%)`,
